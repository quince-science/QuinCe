...
javadoc -sourcepath "$sourcePath" -d "$output" -subpackages uk.ac.exeter.QuinCe:uk.ac.exeter.QCRoutines \
        ...
        -classpath "${jarsDir}/joda-time.jar:${jarsDir}/servlet-api.jar:${jarsDir}/primefaces.jar:${jarsDir}/commons-email.jar:${jarsDir}/commons-math.jar:${jarsDir}/commons-math.jar:${jarsDir}/commons-lang.jar:${jarsDir}/myfaces-api.jar:${jarsDir}/mysql-connector.jar:${jarsDir}/commons-validator.jar" \
        -link https://docs.oracle.com/javase/8/docs/api/ \
        -link https://docs.oracle.com/javaee/7/api/ \
        -link http://www.joda.org/joda-time/apidocs/ \
        -link http://www.primefaces.org/docs/api/5.3/ \
