...
CREATE TRIGGER sensor_types_insert_trigger BEFORE INSERT ON sensor_types FOR EACH ROW SET NEW.modified=NOW();
CREATE TRIGGER sensor_types_update_trigger BEFORE UPDATE ON sensor_types FOR EACH ROW SET NEW.modified=NOW();
...
CREATE TRIGGER variables_insert_trigger BEFORE INSERT ON variables FOR EACH ROW SET NEW.modified=NOW();
CREATE TRIGGER variables_update_trigger BEFORE UPDATE ON variables FOR EACH ROW SET NEW.modified=NOW();
...
CREATE TABLE variable_sensors (
  ...
  KEY VARSENSOR_SENSOR_idx (sensor_type),
...
CREATE TRIGGER variable_sensors_insert_trigger BEFORE INSERT ON variable_sensors FOR EACH ROW SET NEW.modified=NOW();
CREATE TRIGGER variable_sensors_update_trigger BEFORE UPDATE ON variable_sensors FOR EACH ROW SET NEW.modified=NOW();
...
CREATE TABLE instrument_variables (
  ...
  created timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  modified datetime DEFAULT NULL,
  KEY INSTRVAR_INSTRUMENT_idx (instrument_id),
  KEY INSTRVAR_VARIABLE_idx (variable_id),
...
CREATE TRIGGER instrument_variables_insert_trigger BEFORE INSERT ON instrument_variables FOR EACH ROW SET NEW.modified=NOW();
CREATE TRIGGER instrument_variables_update_trigger BEFORE UPDATE ON instrument_variables FOR EACH ROW SET NEW.modified=NOW();
...
CREATE TABLE file_definition (
  ...
  modified datetime DEFAULT NULL,
  PRIMARY KEY (id),
  KEY FILEDEFINITION_INSTRUMENT_idx (instrument_id),
...
CREATE TABLE data_file (
  ...
  modified datetime DEFAULT NULL,
  PRIMARY KEY (id),
  KEY DATAFILE_FILEDEFINITION_idx (file_definition_id),
...
CREATE TABLE dataset (
  ...
  modified datetime DEFAULT NULL,
  PRIMARY KEY (id),
  KEY DATASET_INSTRUMENT_idx (instrument_id),
...
CREATE TABLE measurements (
  ...
  PRIMARY KEY (id),
  KEY MEASUREMENT_DATASET_idx (dataset_id),
...
CREATE TABLE measurement_values (
  ...
  KEY MEASVAL_SENSORVALUE_idx (sensor_value_id),
