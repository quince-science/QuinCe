...
ALTER TABLE calibration ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE calibration_data ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE data_file ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE dataset ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE dataset_data ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE equilibrator_pco2 ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE file_column ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE file_definition ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE instrument ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE job ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE run_type ADD COLUMN modified TIMESTAMP;
...
ALTER TABLE user ADD COLUMN modified TIMESTAMP;
