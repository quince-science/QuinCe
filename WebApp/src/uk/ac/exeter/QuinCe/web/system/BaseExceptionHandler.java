...
/**
 * Basic exception handler. Catches all exceptions and dumps them to the
...
public class BaseExceptionHandler extends ExceptionHandlerWrapper {
  ...
  /*
   *
   * This is the original method from the tutorial page, which we can use to
   * expand functionality in the future. Pasted here in case the page
   * disappears.
   *
