...
public class RoutineFlag extends Flag {
   ...
   */
  private Class<? extends Routine> getRoutineClass() throws ClassNotFoundException {
   ...
   * @return The message
   * @throws RoutineException If the message cannot be retrieved
   */
  ...
  public String getLongMessage() throws RoutineException {
    try {
      Method method = getRoutineClass().getMethod("getLongMessage", String.class, String.class);
