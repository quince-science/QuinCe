...
/**
 * Class to hold the values to be used in a calculation. Generated by a Data
 * Reducer to create a single value for each required sensor type, having
 * performed averaging/interpolation as required.
 *
...
public class CalculationInputValues {
   ...
   *          The QC messages
   */
  public void put(String sensorType, Double value, Flag qcFlag,
    List<String> qcMessages) {
