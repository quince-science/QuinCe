...
public class RunTypeCategoryConfiguration {
   ...
   */
  public RunTypeCategoryConfiguration(Connection conn) throws RunTypeCategoryException {
    init(conn);
  }
  ...
  private void init(Connection conn) throws RunTypeCategoryException {
    ...
    try {
      ...
      throw new RunTypeCategoryException("Error initialising run type categories", e);
    }
  }
   ...
   *   The special IGNORED category (@link {@link RunTypeCategory#IGNORED})
