...
public class ExportException extends Exception {
  ...
  /**
   * Simple constructor for errors occurring in the general export system. These
   * errors are not linked to any specific export configuration.
   * 
   * @param message
   *          The error message
   */
  ...
  /**
   * Constructor for errors that occur in a specific export configuration that
