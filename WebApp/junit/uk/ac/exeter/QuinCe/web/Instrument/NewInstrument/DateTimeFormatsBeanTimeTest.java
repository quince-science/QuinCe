...
public class DateTimeFormatsBeanTimeTest extends TestSetTest {
  ...
  private static final List<String> ALL_FORMATS = Arrays
    .asList(new String[] { DateTimeFormatsBean.T_HHMMSS_COLON_D,
      DateTimeFormatsBean.T_HHMMSS_COLON_MS_D,
      DateTimeFormatsBean.T_HHMMSS_NOSEP_D });

  @ParameterizedTest
  @MethodSource("getLines")
  public void timeFormatTest(TestSetLine line) throws Exception {

    DateTimeFormatsBean bean = new DateTimeFormatsBean();

    bean.setTimeValue(line.getStringField(EXAMPLE_STRING_COL, true));
    Set<String> returnedFormats = bean.getTimeFormats().keySet();
  ...
  protected String getTestSetName() {
    return "DateTimeFormatsBeanTimeTest";
  }
}
