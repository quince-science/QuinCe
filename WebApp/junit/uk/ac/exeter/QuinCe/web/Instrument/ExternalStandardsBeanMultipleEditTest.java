...
public class ExternalStandardsBeanMultipleEditTest
  extends ExternalStandardsBeanEditTest {
  ...
  private void doAction(ExternalStandardsBean bean, int action,
    ...
    if (action != CalibrationEdit.DELETE) {
      ...
      if (changeValue || action == CalibrationEdit.ADD) {
        bean.getEditedCalibration().setCoefficients(
          ExternalStandardsBeanTest.makeCoefficients(replacementValue));
      }
    }
  ...
  protected String getTestSetName() {
    return "ExternalStandardsBeanMultipleEditTest";
  }
