...
ALTER TABLE calibration DROP PRIMARY KEY;

ALTER TABLE calibration ADD COLUMN id INT(11) NOT NULL AUTO_INCREMENT FIRST;
ALTER TABLE calibration ADD PRIMARY KEY (id);
