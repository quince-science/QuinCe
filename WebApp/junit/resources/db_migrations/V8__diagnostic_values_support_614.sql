...
ALTER TABLE file_column ADD `id` INT(11) NOT NULL AUTO_INCREMENT FIRST;
ALTER TABLE file_column ADD PRIMARY KEY (`id`);
...
ALTER TABLE diagnostic_data ADD PRIMARY KEY (file_column_id, measurement_id);
CREATE INDEX DIAGNOSTICDATA_FILECOLUMN_idx ON diagnostic_data(`file_column_id` ASC);
