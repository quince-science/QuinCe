...
-- 2019-06-16T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1011, 1000000, 'EXTERNAL_STANDARD', 'std3', 1560643200000, '300.0;0.0', 'ExternalStandard');

-- 2019-06-16T12:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1012, 1000000, 'EXTERNAL_STANDARD', 'std3', 1560686400000, '300.0;0.0', 'ExternalStandard');

-- 2019-06-16T23:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1013, 1000000, 'EXTERNAL_STANDARD', 'std3', 1560726000000, '300.0;0.0', 'ExternalStandard');

-- 2019-06-20T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1014, 1000000, 'EXTERNAL_STANDARD', 'std3', 1560988800000, '300.0;0.0', 'ExternalStandard');

-- 2019-06-01T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1015, 1000000, 'EXTERNAL_STANDARD', 'std4', 1559347200000, '500.0;0.0', 'ExternalStandard');

-- 2019-06-04T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1016, 1000000, 'EXTERNAL_STANDARD', 'std4', 1559606400000, '500.0;0.0', 'ExternalStandard');

-- 2019-06-12T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1017, 1000000, 'EXTERNAL_STANDARD', 'std4', 1560297600000, '500.0;0.0', 'ExternalStandard');

-- 2019-06-20T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1018, 1000000, 'EXTERNAL_STANDARD', 'std4', 1560988800000, '500.0;0.0', 'ExternalStandard');
