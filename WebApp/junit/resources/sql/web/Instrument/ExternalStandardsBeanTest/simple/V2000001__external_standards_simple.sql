...
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1001, 1000000, 'EXTERNAL_STANDARD', 'TARGET1', 1559347200000, '200.0;0.0', 'ExternalStandard');

-- 2019-06-01T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1002, 1000000, 'EXTERNAL_STANDARD', 'TARGET2', 1559347200000, '400.0;0.0', 'ExternalStandard');

-- 2019-06-01T00:00:00
INSERT INTO calibration (id, instrument_id, type, target, deployment_date, coefficients, class)
  VALUES (1003, 1000000, 'EXTERNAL_STANDARD', 'TARGET3', 1559347200000, '500.0;0.0', 'ExternalStandard');
