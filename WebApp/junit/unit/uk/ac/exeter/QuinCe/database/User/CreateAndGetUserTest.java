...
public class CreateAndGetUserTest extends BaseDbTest {
	...
	public void testNullConnection() throws Exception {
		...
		UserDB.createUser(nullConnection, TEST_USER_EMAIL, "mypassword".toCharArray(), "Steve", "Jones");
	}
	
	@Test(expected=MissingDataException.class)
	public void testNullEmail() throws Exception {
		String nullEmail = null;
		UserDB.createUser(getConnection(), nullEmail, "mypassword".toCharArray(), "Steve", "Jones");
	}
	
	@Test(expected=MissingDataException.class)
	public void testNullPassword() throws Exception {
		char[] nullPassword = null;
		UserDB.createUser(getConnection(), TEST_USER_EMAIL, nullPassword, "Steve", "Jones");
	}
	
	@Test(expected=MissingDataException.class)
	public void testNullGivenName() throws Exception {
		String nullGivenName = null;
		UserDB.createUser(getConnection(), TEST_USER_EMAIL, "mypassword".toCharArray(), nullGivenName, "Jones");
	}
	
	@Test(expected=MissingDataException.class)
	public void testNullSurname() throws Exception {
		String nullSurname = null;
		UserDB.createUser(getConnection(), TEST_USER_EMAIL, "mypassword".toCharArray(), "Steve", nullSurname);
	}
